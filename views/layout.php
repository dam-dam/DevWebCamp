...
<head>
    ...
    <script 
        src="https://www.paypal.com/sdk/js?client-id=Ae9iiBAJBawskuY-1-EznOXbaVgEhhVK_As7kGo3JAJx7lDEIbP3elbwarq0XHvQkWeoREWmh24WkM43&components=buttons&currency=MXN">
    </script>
</head>
<body>
    <?php 

<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        <label for="categoria" class="formulario__label">Seleccion de Dias</label>
    ...
    <div class="formulario__campo">
        <label for="categoria" class="formulario__label">Seleccion de Horas</label>
...
<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        <label for="ponentes" class="formulario__label">Ponente Evento</label>
        <input 
        type="text"
        class="formulario__input"
        id="ponentes"
